...
typedef enum {SEGCP_MC, SEGCP_VR, SEGCP_MN, SEGCP_IM, SEGCP_OP, SEGCP_CP, SEGCP_DG, SEGCP_KA, SEGCP_KI, SEGCP_KE,
              ...
              SEGCP_UF, SEGCP_FW, SEGCP_SO, SEGCP_SD, SEGCP_DD, SEGCP_QS, SEGCP_EN, SEGCP_EI, SEGCP_AO, SEGCP_QL,
              SEGCP_QH, SEGCP_AP, SEGCP_EB, SEGCP_ED, SEGCP_EP, SEGCP_ES, SEGCP_EF, SEGCP_ND, SEGCP_NS, SEGCP_AT,
              SEGCP_RV, SEGCP_RR, SEGCP_RA, SEGCP_RS, SEGCP_RE, SEGCP_RO, SEGCP_EO, SEGCP_RD, SEGCP_RF, SEGCP_SE,
              SEGCP_EE,
#if (DEVICE_UART_CNT > 2)
              SEGCP_GS, SEGCP_WN, SEGCP_WI, SEGCP_TO, SEGCP_GL, SEGCP_GH, SEGCP_TP,
              SEGCP_WB, SEGCP_WD, SEGCP_WP, SEGCP_WS, SEGCP_WF, SEGCP_HD, SEGCP_HS,
              SEGCP_TT, SEGCP_XV, SEGCP_XR, SEGCP_XA, SEGCP_XS, SEGCP_XE, SEGCP_XO,
              SEGCP_WO, SEGCP_XD, SEGCP_XF, SEGCP_WE,           // ch2 (25)
#endif
#if (DEVICE_UART_CNT > 3)
              SEGCP_CS, SEGCP_YN, SEGCP_YI, SEGCP_JO, SEGCP_CL, SEGCP_CH, SEGCP_JP,
              SEGCP_YB, SEGCP_YD, SEGCP_YP, SEGCP_YS, SEGCP_YF, SEGCP_UD, SEGCP_US,
              SEGCP_JT, SEGCP_ZV, SEGCP_ZR, SEGCP_ZA, SEGCP_ZS, SEGCP_ZE, SEGCP_ZO,
              SEGCP_YO, SEGCP_ZD, SEGCP_ZF, SEGCP_YE,           // ch3 (25)
#endif
              SEGCP_UNKNOWN = 255
             } teSEGCPCMDNUM;
#if 0
